...
import { cogmateWS } from '@/services/CogmateWebSocketClient';
    ...
    const setupListener = async () => {
      try {
        ...
        unlistenFn = await transcriptService.onTranscriptUpdate((update) => {
          ...
          // NEW: Send to Cogmate Backend
          cogmateWS.sendTranscript(update.text, update.is_partial);
