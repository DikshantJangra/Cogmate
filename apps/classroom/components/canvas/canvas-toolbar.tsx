...
function CtrlDivider() {
  return <div className="w-px h-3 bg-slate-100 mx-0.5 shrink-0" />;
}
  ...
  return (
    <div className={cn('flex items-center gap-2', className)}>
      ...
      <div className="flex items-center gap-1 shrink-0 pl-1">
        ...
        <span className="text-[10px] text-slate-300 tabular-nums select-none font-bold uppercase tracking-tight">
          {currentSceneIndex + 1}
        ...
        >
          ...
          {onToggleMute && (
            ...
            >
              ...
              >
                <div className="bg-white border border-slate-100 rounded-xl shadow-xl shadow-slate-200/50 px-2 py-2.5 flex flex-col items-center gap-1.5">
                  <span className="text-[9px] text-slate-400 tabular-nums font-bold select-none">
                ...
                {/* Arrow pointing down */}
                <div className="w-2 h-2 bg-white border-b border-r border-slate-100 rotate-45 -mt-[5px]" />
              </div>
            </div>
          )}
                ...
                <TooltipTrigger asChild>
                  <button
                    ...
                    className={cn(
                      ...
                      'transition-all duration-150 outline-none cursor-pointer',
                      'text-[10px] font-bold tabular-nums leading-none uppercase tracking-tight',
                      'active:scale-90',
                      playbackSpeed !== 1
          ...
          {scenesCount > 1 && (
            <button
              ...
              className={cn(
                ctrlBtn,
                'w-6 h-6 text-slate-400 disabled:opacity-20 disabled:pointer-events-none',
              )}
          ...
          >
            ...
            {!whiteboardOpen && whiteboardElementCount > 0 && (
              <span className="absolute top-0.5 right-0.5 w-1 h-1 bg-blue-500 rounded-full" />
            )}
          </button>
        </div>
      </div>
